...
public static class Localizer
{
    private static readonly IReadOnlyDictionary<string, string> Chinese = new Dictionary<string, string>
    {
        ...
        ["OneDrive.UploadUnauthorized"] = "管理员上传密码错误",
        ["OneDrive.UploadConflict"] = "服务器数据已变化，请先拉取后重试",
        ["OneDrive.UploadRateLimited"] = "上传尝试过多，请稍后再试",
        ["OneDrive.Pulled"] = "远程数据已拉取",
        ["OneDrive.Cached"] = "远程线路暂不可用，已使用上次缓存",
        ["OneDrive.Unavailable"] = "同步源不可用",
        ["OneDrive.Error"] = "远程同步失败",
        ["AdminUpload.Title"] = "管理员上传",
        ["AdminUpload.Password"] = "输入管理员上传密码（不会保存）：",
        ["Common.OK"] = "确定",
        ["Common.Cancel"] = "取消",
        ["Grid.Uid"] = "UID",
        ...
        ["ServerLatency.Checking"] = "服务器：检测中…",
        ["ServerLatency.Value"] = "服务器：{0} ms",
        ["ServerLatency.Timeout"] = "服务器：超时",
        ["ServerLatency.Offline"] = "服务器：离线",
    ...
    {
        ["App.Title"] = "War Thunder UID Guard · v{0}",
        ["App.Subtitle"] = "UID blacklist · Live monitor",
        ...
        ["OneDrive.UploadUnauthorized"] = "The administrator upload password is incorrect",
        ["OneDrive.UploadConflict"] = "Server data changed; pull and retry",
        ["OneDrive.UploadRateLimited"] = "Too many upload attempts; try again later",
        ...
        ["AdminUpload.Title"] = "Administrator upload",
        ["AdminUpload.Password"] = "Enter the administrator upload password (not saved):",
        ["Common.OK"] = "OK",
        ...
        ["Status.NotStarted"] = "Not monitoring",
        ["Status.Connecting"] = "Connecting…",
        ["Status.Connected"] = "War Thunder connected",
        ["Status.Stopped"] = "Monitoring stopped",
        ["Status.WaitingForBattle"] = "Waiting for a battle…",
        ["Status.ConnectionFailed"] = "Connection failed",
        ["ServerLatency.Checking"] = "Server: testing",
        ["ServerLatency.Value"] = "Server: {0} ms",
        ["ServerLatency.Timeout"] = "Server: timed out",
        ["ServerLatency.Offline"] = "Server: offline",
